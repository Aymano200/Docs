...
Here, you can enter your email if you want. We do suggest using a temporarily email from [Smailpro](https://smailpro.com) though, just be sure to take note of your account credentials as you will not be able to recover the password at a later time.
...
BYOD: Join our [Discord](https://discord.gg/interstellar) for more information