...
Go to https://freedns.afraid.org and click "Subdomains", then click "Sign Up Free".

Here, you can enter your email if you want. We do suggest using a temporarily email from https://smailpro.com though, just be sure to take note of your account credentials as you will not be able to recover the password at a later time.
